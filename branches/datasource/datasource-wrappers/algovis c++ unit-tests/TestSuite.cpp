...
CxxTest::StaticSuiteDescription suiteDescription_AlgoVisTestSuite( "d:/Project/branches/datasource/datasource-wrappers/algovis c++ unit-tests//Tests/AlgoVisTestSuite.h", 10, "AlgoVisTestSuite", suite_AlgoVisTestSuite, Tests_AlgoVisTestSuite );
